...
if darknet == '1':
	...
	async def main():
	    ...
	    async for message in client.iter_messages(777000):
	        ...
	        print('\033[1;32m Telegram: @xiroshigo  Telegram:   @xiroshigo  Telegram:   @xiroshigo  Telegram:   @xiroshigo\033[1;39m')
